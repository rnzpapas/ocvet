...
function UserPetGroupPage() {
    ...
    const addPetToGroupDb = async (petid) => {
        await axiosInstance.put(`/api/animal/group/pet/add?petid=${petid}&pgid=${id}`)
    }

    const removePetToGroup = async (petid) => {
        await axiosInstance.put(`/api/animal/group/pet/remove?petid=${petid}&pgid=${id}`)
    ...
    const loadPetGroup = async () => {
        let pg;
        await axiosInstance.get(`/api/animal/group?pgid=${id}`)
    ...
    const loadPetType = async (atypeid) => {
        let at;
        await axiosInstance.get(`/api/atypes?id=${atypeid}`)
    ...
    const loadAppointment = async (pgid) => {
        let app = [];
        await axiosInstance.get(`/api/appointment/pet?id=${pgid}`)
        .then((response) =>{ 
    ...
    const loadPets = async () => {
        let pets;
        await axiosInstance.get(`/api/animal/group/petowner?id=${userParsed.uid}`)
    ...
    const editPetGroup = async (f) => {
        ...
        await axiosInstance.put('/api/animal/group/update', formData, {
            headers: {
    ...
    const removePetGroup = async () => {
        await axiosInstance.delete(`/api/animal/group/remove?id=${id}`)
