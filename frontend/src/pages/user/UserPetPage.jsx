            ...
            <section className="flex flex-col-reverse lg:flex-row px-5 py-5 gap-5 lg:gap-0 lg:h-dvh">
                ...
                <section className="lg:w-[80%]">
                    ...
                    <section className="mt-5 flex flex-wrap gap-2 lg:gap-5 max-h-[90%] overflow-y-auto overflow-x-hidden">
                        ...
                        <div className="flex flex-col gap-1.5 items-center cursor-pointer" onClick={redirectToRegisterPage}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-[50px lg:w-[60px] xl:w-[80px] fill-silver hover:fill-raisin-black">
