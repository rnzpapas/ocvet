...
function MngrAnnouncements() {
    ...
    const onEmailSearch = async (evt) => {
        ...
        await axiosInstance.get(`/api/admin/email?email=${email}`,
    ...
    const onSubmitAnnouncement = async () => {
        ...
        await axiosInstance.post('/api/announcement/create', formData, {headers: {"Content-Type": 'application/json'}})
            ...
            <section className="px-5 py-5 w-full">
                ...
                <section className={`${isCreateMssgOpened ? 'flex flex-col gap-2 h-[50%]' : 'hidden'}`}>
                    ...
                    <section className="">
                        ...
                        <textarea onChange={(el) => onMessageChange(el)} name="" id="" className="px-2 w-full h-[150px] border border-silver resize-none font-lato text-content-lrg"></textarea>
