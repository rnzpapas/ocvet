      ...
      <section className="flex">
          <section className={`${style}`}>
              <section className="flex items-center gap-2">
                  <h5 className="font-instrument-sans font-semibold xl:text-headline-md text-raisin-black">Personal Details</h5>
              ...
              <section>
                  <section className="flex items-center gap-2">
                      ...
                      <p className="font-lato text-raisin-black text-content-sm">{fullName}</p>
                  </section>
                  <section className="flex items-center gap-2">
                      <h5 className="font-instrument-sans font-semibold text-raisin-black">Address:</h5>
                      <p className="font-lato text-raisin-black text-content-sm">{address}</p>
                  </section>
                  <section className="flex items-center gap-2">
