...
export const createAnimalGroupService = async (PETS, ATYPEID, POPULATION, GROUP_NICKNAME, CREATED_TIMESTAMP) => {
    let new_pgid;
    ...
    const res = await pool.query('INSERT INTO otcv_pet_group ("PGID", "PETS", "ATYPEID", "POPULATION", "GROUP_NICKNAME", "CREATED_TIMESTAMP") VALUES ($1, $2, $3, $4, $5, $6)', 
        [new_pgid, PETS, ATYPEID, POPULATION, GROUP_NICKNAME, CREATED_TIMESTAMP]);
}
